                  ...
                  <div className="mt-3">
                    ...
                    <div className="mt-2 grid grid-cols-7 gap-1 text-sm">
                      ...
                      {Array.from({length: 35}).map((_, i) => {
                        ...
                        return (
                          <div key={i} className={`h-14 p-1 rounded-md ${dayEvents.length ? 'bg-muted/40' : 'bg-card'}`}>
                ...
                <div className="p-4 space-y-4">
                  ...
                  {recommendations.map((r:any) => (
                    <div key={r.id} className="flex items-start gap-3">
                      <div className="w-12 h-12 rounded-xl gradient-hero flex items-center justify-center text-sm font-semibold text-primary-foreground">{(r.user?.firstName||'U').charAt(0)}</div>
                ...
                <div className="p-5 space-y-4">
                  {recentTeachers.map((teacher) => (
                    <div key={teacher.id} className="flex items-center gap-3">
                      <div className="w-11 h-11 rounded-xl gradient-hero flex items-center justify-center text-sm font-semibold text-primary-foreground">{(teacher.firstName||'T').charAt(0)}</div>
                      <div className="flex-1 min-w-0">
